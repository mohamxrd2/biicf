            ...
            <div class="relative mx-auto max-w-4xl grid space-y-5 sm:space-y-10">
                ...
                <div class="text-center">
                    ...
                    <h1
                        ...
                        Bourse du commerce <span class="text-blue-500">Et du financement</span>
                    </h1>
                </div>
                <!-- End Title -->
                ...
                <div class="sm:flex sm:justify-center sm:items-center text-center sm:text-start">
                    <div class="flex-shrink-0 pb-5 sm:flex sm:pb-0 sm:pe-5">
                        ...
                        <div class="flex justify-center -space-x-3">
                            ...
                            <img class="inline-block size-8 rounded-full ring-2 ring-white dark:ring-gray-800"
                                ...
                                alt="Image Description">
                            <span
                                class="inline-flex items-center justify-center size-8 rounded-full ring-2 ring-white bg-gray-800 dark:bg-gray-900 dark:ring-gray-800">
                    ...
                    <div
                        class="border-t sm:border-t-0 sm:border-s border-gray-200 w-32 h-px sm:w-auto sm:h-full mx-auto sm:mx-0 dark:border-gray-700">
                    </div>
